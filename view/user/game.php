    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-white min-vh-100">
            ...
            <div class="d-flex align-items-center py-4 border-bottom mb-4 sticky-top bg-white" style="z-index: 90;">
                ...
                <a href="index.php?action=game" class="filter-pill"><i class="bi bi-controller"></i> Game</a> 
                <a href="index.php?action=lagu" class="filter-pill"><i class="bi bi-controller"></i> Lagu</a>                
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <?php
                    // Jika ada file view khusus (contoh: filter Game), tampilkan itu saja
                    if (isset($view) && file_exists($view)) {
                        include $view;
                        return; // Stop supaya foreach default tidak dijalankan
                    }
                    ?>
