        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-0 px-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?action=admin_rangking">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-white min-vh-100">
                ...
                <div class="d-flex align-items-center py-4 border-bottom mb-4 sticky-top bg-white" style="z-index: 90;">
                    ...
                    <a href="index.php?action=filter_lagu_admin" class="filter-pill active"><i class="bi bi-music-note-beamed"></i> Music</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <?php foreach ($posts as $p): ?>
                            <div class="post-card">
                                <form action="index.php?action=admin_hapus_post" method="POST" 
                                      onsubmit="return confirm('Yakin ingin menghapus postingan ini?');"
                                      class="position-absolute" 
                                      style="right: 250px; margin-top: -5px;">
                                ...
                                <div class="mt-3 pt-3 border-top d-flex gap-4 text-muted">
                                    ...
                                    <a class="komen" href="index.php?action=komentar_admin&post_id=<?= $postId ?>" style="text-decoration:none;">
